...
def get_path_number(get_birthdate)
    case get_birthdate
        when 1
        ...
        when 5
        message = "This is the freedom lover.  The number five is an intellectual vibration.  These are the 'idea' people with a love of variety and the ability to adapt to most situations.  Ruled by Mercury"
        when 6
        message = "This is the peace lover.  Ther number six is a loving, stable, and harmonious vibration.  Ruled by Venus."
        when 7
...
puts "What is your Birthday? (please write it like this: MMDDYYYY"
birthdate = gets


birth_path_num = get_birthdate(birthdate)

message = get_path_number(get_birthdate)
